...
public class Cuadrupla {
    ...
    public void setOpCode(int TipoOp) { //Setter del Tipo de Operación
    ...
    public final void Make(int TipoOp, int Dir1, int Dir2, int Dir3){  //Actualiza TODOS los campos de la Cuadrupla.
       this.OpCode = TipoOp;
       this.Dir[0] = Dir1;
       this.Dir[1] = Dir2;
       this.Dir[2] = Dir3;
...
//*******    
    ...
    private String toString1(){ //Devuelve la Cuadrupla as String sii su OpCode usa una sola Dir.
        int Dir1  = getDir(1);
        String op = OPCODE.OpCodeToStr(OpCode);     //Símbolo de la Operacion (e.g. op="CALL")
        switch (OpCode){
