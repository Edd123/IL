...
//*******    
    ...
    public static int getCantDirs(int OpCode){  //Devuelve la cantidad de Direcciones que usa la OpCode.            
...
//*******    
    ...
    public static String Mnemonico(int OpCode){    //Devuelve el mnemónico del OpCode dado
    ...
    public static String OpCodeToStr(int OpCode){    //Devuelve el mnemónico o símbolo que caracteriza al OpCode dado.
