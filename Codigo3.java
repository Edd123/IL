...
public class Codigo3 {
    ...
    public int add(int OpCode, int Dir1, int Dir2, int Dir3){   //Inserta un instrucción que usa 3 direcciones.
        ...
        C.Make(OpCode, Dir1, Dir2, Dir3);   //Pasar la instrucción a una Cuadrupla.
    ...
    public boolean Open(String Filename){        
        ...
        if (!b)
            System.err.println("Codigo3.Open: El archivo "+'"'+Filename+'"'+ " no tiene el formato de un .gr3");
...
//    }  
    ...
    private DataInputStream OpenToRead(String Filename){ //Abre, para leer, el archivo FileName, retornan do el flujo abierto.
        try{
